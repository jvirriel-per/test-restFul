package com.jvirriel.testrestful.backend.configuration.restquery;
...
public class GenericRsqlSpecification<T> implements Specification<T> {
    ...
    public GenericRsqlSpecification(final String property, final ComparisonOperator operator, final List<String>
            arguments) {
        super();
